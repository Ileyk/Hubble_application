...
~      & \hspace*{-1.6cm}\emph{MPI-AMRVAC 2.0 for solar and astrophysical applications} (2018) - ApJS\\ \\

~      & \hspace*{-2.0cm}\href{http://adsabs.harvard.edu/abs/2017arXiv171108709E}{[1]} \textbf{El Mellah I.}, Sundqvist J. O. \& Keppens R.\\ 
~      & \hspace*{-1.6cm}\emph{Accretion from a clumpy massive-star wind in Supergiant X-ray binaries} (2018)\\
~      & \hspace*{-1.7cm} MNRAS\\ \\
...
& \vspace{0,4cm} \hspace{-2,1cm} \activite{Conferences}\\

\hspace*{0.35cm}Oc 2018
        & \hspace*{0.4cm}Leuven-Amsterdam-Bonn massive stars meeting\\

\hspace*{0.35cm}Ag 2018
        & \hspace*{0.4cm}IAU General Assembly - High Mass X-ray Binaries symposium\\
...
\hspace*{0.35cm}Jl 2017
        & \hspace*{0.4cm}Paris - French Astronomy Society meeting\\ 

\hspace*{0.35cm}Mr 2017
        & \hspace*{0.4cm}Brussels Royal Observatory - CHARM meeting\\

\hspace*{0.35cm}Fb 2017
        & \hspace*{0.4cm}ISSI Bern workshop - Stellar Winds in Massive X-ray Binaries\\
